...
class RpcErrorException(Exception):
    ...
    def get_rpc_model(self, id: Union[str, int, None], include_data: bool = ...) -> RpcError: ...

def method_callback_example(params: Optional[Any]) -> Optional[Any]: ...

class SlxJsonRpc:
    log: logging.Logger
    def __init__(self, methods: Optional[Type[Enum]] = ..., method_cb: Optional[Dict[str, Callable[[Any], Any]]] = ..., result: Optional[Dict[str, Union[type, Type[Any]]]] = ..., params: Optional[Dict[str, Union[type, Type[Any]]]] = ..., verbose_errors: bool = ...) -> None: ...
    def create_request(self, method: str, callback: Callable[[Any], None], error_callback: Optional[Callable[[ErrorModel], None]] = ..., params: Optional[Any] = ...) -> Optional[RpcRequest]: ...
    def create_notification(self, method: str, params: Optional[Any] = ...) -> Optional[RpcNotification]: ...
